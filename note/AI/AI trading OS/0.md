...
![image-20251104175851688](image-20251104175851688.png)

![image-20251104175909054](image-20251104175909054.png)

# docs：nofx项目

`nofx`项目是一个**AI驱动的加密货币交易系统**，设计用于在多个交易所上自主运行。

- 其核心是**AI自动交易器**，作为每个交易机器人的"大脑"，通过先进的**AI决策引擎**基于实时**市场数据**生成交易策略
