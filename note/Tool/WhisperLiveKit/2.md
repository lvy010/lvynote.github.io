...
在上一章[服务端与前端接口](01_server___frontend_interface_.md)中，我们了解了浏览器如何捕获语音并通过"音频分块"发送至WhisperLiveKit服务端

这就像将生鲜食材送至厨房，但食材不能直接用于烹饪（AI模型处理）——需要经过清洗、切割与分装
